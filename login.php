   ...
   <div class="center">
      ...
      <div class="login">
        <label>
          ...
          <input class="username" type="text" name="username" autocomplete="on" placeholder="username"/>
        </label>
        <label>
        ...
        <p style="text-align: center;">Do you have an account?<a href="registration.php">Register</a></p>
        <p style="text-align: left;"><a href="forgot.php">forgot password</a></p>
        </form>
